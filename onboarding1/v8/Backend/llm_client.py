...
import re
from v8.Backend.prompts import CONVERSATION_SYSTEM_PROMPT, TITLE_SYSTEM_PROMPT, EXTRACTION_SYSTEM_PROMPT, DOCUMENT_EXTRACTOR_PROMPT
# -------------------------
# Config
# -------------------------
...
def extract_document_parameters(text: str) -> dict:
    
    prompt = f"{DOCUMENT_EXTRACTOR_PROMPT} Document:{text[:20000]}" 
    
    response = chat_llm([
        {"role": "system", "content": "You are a structured financial document extractor."},
